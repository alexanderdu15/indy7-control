...
private:
    void stateCallback(const std_msgs::msg::Float64MultiArray::SharedPtr msg)
    {
        ...
        RCLCPP_DEBUG(this->get_logger(), "<stateCallback()>: Received state: %f, %f, %f, %f, %f, %f at time %f", current_state_[0], current_state_[1], current_state_[2], current_state_[3], current_state_[4], current_state_[5], current_time_);
    ...
    void publishTraj()
    {
        ...
        RCLCPP_DEBUG(this->get_logger(), "<publishTraj()>: Publishing trajectory @ start time: %f", current_trajopt_time_);
...
int main(int argc, char * argv[])
{
    ...
    char eePos_traj_file_name[100] = "/home/a2rlab/Desktop/Indy7/mpc/trajectories/circle_traj_eePos_meters.csv";
